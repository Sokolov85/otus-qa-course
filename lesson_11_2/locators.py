...
class ConctructorPageLocators(object):
    """A class for menu constructor page locators"""
    CONSTRUCTOR_PAGE_URL = "http://demo23.opencart.pro/admin/index.php?route=design/custommenu&token="
    PRODUCT_ITEM_1 = (By.ID, 'custommenu-child-item-42')
    PRODUCT_ITEM_2 = (By.ID, 'custommenu-child-item-41')
